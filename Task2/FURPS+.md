...
| F17 | [Система кредитования] СМС оповещение клиента о статусах заявки на кредит                                |              |
| F18 | [Система кредитования] СМС-оповещение клиента о необходимости посещения офиса для продоложения оформления кредита                                |              |
| F19 | [Система кредитования] Проверка существования открытой заявки перед оформлением новой                               |              |
| F20 | [Система кредитования] Реализация упрощенного пути согласования выдачи кредита по предодобренным заявкам                               |              |
