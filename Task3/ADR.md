...
|UC6|Клиент, интернет-банк|Подача заявки на открытие депозита|1. Клиент выбирает "открыть депозит"<br/> 2. Интернет-банк отображает форму с полями: счёт, сумма депозита <br/> 3. Клиент отправляет данные<br/> 4. Клиент получает СМС с кодом подтверждения и вводит его в открывшемся окне интернет-банка 5. Интернет-банк показывает сообщение об успехе|
